...
export default function AccountCreation() {
  ...
  async function handlesubmitTester(e: any) {
    e.preventDefault();
    ...
    const dataResponse = await fetch("http://localhost:8080/users", {
      method: "POST",
      headers: {
    ...
    console.log(result);
    // const dataResponse = await fetch("http://localhost:8080/projects");
